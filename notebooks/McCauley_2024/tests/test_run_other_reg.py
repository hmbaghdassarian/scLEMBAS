...
parser.add_argument("--network_noise", type=str_to_bool, required=True)

parser.add_argument("--bn_weights_lambda_L2", type=float, required=True)
parser.add_argument("--moa_lambda_L1", type=float, required=True)
parser.add_argument("--output_weights_lambda_L2", type=float, required=True)
parser.add_argument("--output_bias_lambda_L2", type=float, required=True)
...
network_noise = args.network_noise

bn_weights_lambda_L2 = args.bn_weights_lambda_L2
moa_lambda_L1 = args.moa_lambda_L1
output_weights_lambda_L2 = args.output_weights_lambda_L2
output_bias_lambda_L2 = args.output_bias_lambda_L2
discriminator_lambda_L2 = args.discriminator_lambda_L2




#python test_run_other_reg.py --index 29_2 --retrain false --max_epochs 1200 --per_condition_reconstruction_loss true --n_batches 20 --vae_param_reg 1e-5 --vae_scaling_KL 5e-3 --n_cat_discriminator_train 10 --n_pert_discriminator_train 10 --cat_dropout 0.1 --pert_dropout 0.3 --n_adversarial_start 200 --main_max_lr 2e-3 --gen_max_lr 5e-4 --cat_max_lr 1e-3 --pert_max_lr 1e-3 --cat_max_penalty_weight 11 --cat_b_adv 2.5 --pert_max_penalty_weight 10 --pert_b_adv 2.75 --generator_dropout_rate 0.7 --cat_epsilon_smooth 0.1 --pert_epsilon_smooth 0.1 --n_layers_vae 3 --start_layers_pert true --cat_bias_pert_scaler 100 --cat_pert_pert_label false --cat_bias_lambda_L2 2.5e-4 --spectral_loss_factor 0 --uniform_lambda_L2 0 --cat_spectral_norm true --pert_spectral_norm true --network_noise true --bn_weights_lambda_L2  1e-7 --moa_lambda_L1 1e2 --output_weights_lambda_L2 1e-7  --output_bias_lambda_L2 1e-7 --discriminator_lambda_L2 1e-3

#python test_run_other_reg.py --index 21_4 --retrain false --max_epochs 600 --per_condition_reconstruction_loss true --n_batches 15 --vae_param_reg 1e-5 --vae_scaling_KL 5e-3 --n_cat_discriminator_train 10 --n_pert_discriminator_train 10 --cat_dropout 0.1 --pert_dropout 0.3 --n_adversarial_start 200 --main_max_lr 2e-3 --gen_max_lr 5e-4 --cat_max_lr 1e-3 --pert_max_lr 1e-3 --cat_max_penalty_weight 11 --cat_b_adv 2.5 --pert_max_penalty_weight 10 --pert_b_adv 2.75 --generator_dropout_rate 0.7 --cat_epsilon_smooth 0.1 --pert_epsilon_smooth 0.1 --n_layers_vae 3 --start_layers_pert true --cat_bias_pert_scaler 100 --cat_pert_pert_label false --cat_bias_lambda_L2 5e-4 --spectral_loss_factor 0 --uniform_lambda_L2 0 --cat_spectral_norm true --pert_spectral_norm true --network_noise true --bn_weights_lambda_L2  1e-7 --moa_lambda_L1 1e2 --output_weights_lambda_L2 1e-7  --output_bias_lambda_L2 1e-7 --discriminator_lambda_L2 1e-3
...
if network_noise:
    noise_params = {
        ...
        noise_params = {
        'network_noise_scale': 0, #0.01, 
        'min_network_noise': 0, #0.0025, #0.0015, #0.0025, 
        'gradient_noise_scale': 0, #1e-9, 
        'include_gradient_noise_vae': False, 
        'include_gradient_noise_embedding': False, 
        'constant_gradient_noise': False
...
regularization_params = {
    ...
    'moa_lambda_L1': moa_lambda_L1, #1e2,
    ...
    'output_weights_lambda_L2': output_weights_lambda_L2, #1e-7,
    'output_bias_lambda_L2': output_bias_lambda_L2, #1e-7,
...
discriminator_params = {
    ...
    'lr_restart_factor': 1,
    'optimizer': torch.optim.Adam,
    'discriminator_lambda_L2': discriminator_lambda_L2, #1e-3,
