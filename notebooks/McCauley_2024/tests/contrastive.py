...
contrastive_loss_params = {
    'methods': ['sc_actual', 'sc_predicted'], 
    'lambda_scalers': [1.0, 0.2], 
    'understimate_only': True, # only for _bulk_actual
    'min_percentile': 0.3, # only for _sc
    'triplet_margin_frac': 0.1, # for sc only
}
