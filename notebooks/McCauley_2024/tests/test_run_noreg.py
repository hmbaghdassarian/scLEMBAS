...
regularization_params = {
    ...
    'bn_weights_lambda_L2': 0,#1e-7,
    'moa_lambda_L1': 0, #1e2,
    'uniform_lambda_L2': 0,#uniform_lambda_L2, #0, #1e-7, 
    'uniform_min': 0, #-1/projection_amplitude_out,
    'uniform_max': 0, #1/projection_amplitude_out,
...
cat_discriminator_params['epsilon_smooth'] = 1e-10 #min(0.1, 1/tf_adata.obs[cat_col].nunique())
pert_discriminator_params['epsilon_smooth'] = 1e-10 #min(0.1, 1/tf_adata.obs[pert_col].nunique())
