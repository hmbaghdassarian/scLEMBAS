...
noise_params = {
    ...
    'include_gradient_noise_vae': False, #True, 
    'include_gradient_noise_embedding': False, #True, 
...
regularization_params = {
    ...
    'bn_weights_lambda_L2': 1e-9, #1e-7,
    'moa_lambda_L1': 1, #1e2,
    ...
    'output_weights_lambda_L2': 1e-9, #1e-7,
    'output_bias_lambda_L2': 1e-9, #1e-7,
...
discriminator_params = {
    ...
    'lr_restart_factor': 1,
    'optimizer': torch.optim.Adam,
    'discriminator_lambda_L2': 1e-5, #1e-3,
...
cat_discriminator_params['epsilon_smooth'] = 0.0001 #min(0.1, 1/tf_adata.obs[cat_col].nunique())
pert_discriminator_params['epsilon_smooth'] = 0.0001 #min(0.1, 1/tf_adata.obs[pert_col].nunique())
