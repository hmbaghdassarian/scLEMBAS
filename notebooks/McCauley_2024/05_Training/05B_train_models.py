...
sys.path.insert(1, '../.')
from McCauley_utils import load_data, initialize_mod_and_trainer, all_data
...
# # To do:
# - check that mod_actual is initialized the same as mod 2B
# - do the same thing with Kang
