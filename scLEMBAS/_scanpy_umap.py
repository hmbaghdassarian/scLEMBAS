...
def scanpy_umap(
    ...
    *,
    ...
    Main changes from scanpy's default functions:
    
    1) stores the fit umap model to adata.uns['umap']['umap_mod']
    2) analogous implementation of simplicial_set_embedding that generates the model
...
#             gamma=gamma,
        ...
        umap.graph_ = neighbors["connectivities"]
    ...
    adata.uns[key_uns]['umap_mod'] = umap
