"""
Implements a linear warmup for the cosine annealing with warm restarts.

Code copied directly from https://github.com/saadnaeem-dev/pytorch-linear-warmup-cosine-annealing-warm-restarts-weight-decay/blob/main/linear_warmup_cosine_annealing_warm_restarts_weight_decay/lr_scheduler.py. Commit SHA: 73bf9581977a7bef199aaf73618b37c7366debbe
"""
