...
from .bionetwork_dev_global_scaler import BioNetSimple, BioNetCat, BioNetSC
    ...
    def __init__(self, net: pd.DataFrame, X_in: pd.DataFrame, y_out: pd.DataFrame,
        ...
        bionet_params : Dict[str, float], optional
            ...
            Key values include:
                ...
                - 'bias_global_scaler' : divides the output total bias amount by this value
                - 'signaling_weights_scaler' : multiplies the signaling weights by this amount during forward pass
