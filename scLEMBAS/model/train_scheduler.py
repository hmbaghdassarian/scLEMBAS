...
class TrainSC(TrainBase):
    ...
    def __init__(self,
                 ...
                 n_discriminator_train: int = 1, # train generator as frequently as discriminator
        ...
        n_adversarial_start : int, optional
            when to start adversarial training (before this, only the adj and categorical bias are used)
        ...
        n_discriminator_train : int, optional
            how frequently to train the generator relative to the discriminator, by default 1
